...
public class SortedLinkedList<T> extends LinkedList<T> implements Cloneable
{
	...
	/**
	 * Finds index of item in sorted list (smallest value at 0th index) using binary
	 * search method. This will not return an error if the list is not sorted. If
	 * list is not sorted, a nonsensical index is returned
	 *
	 * @param item
	...
	/**
	 * Finds index of item in sorted list (smallest value at 0th index) with maximum
	 * and minimum index bounds using binary search method. This will not return an
	 * error if the list is not sorted. If list is not sorted, a nonsensical index
	 * is returned
	 *
	 * @param item
	 *            the item to find in the list
	 * @param min
	 *            the min of the range to search
	 * @param max
	 *            the max of the range to search
	 * @return the index of the item in the list
	 */
	...
	/**
	 * Finds index to insert item in sorted list (smallest value at 0th index) with
	 * maximum and minimum index bounds using binary search method. This will not
	 * return an error if the list is not sorted. If list is not sorted, a
	 * nonsensical index is returned
	 *
	 * @param item
	 *            the item to insert in the list
	 * @param min
	 *            the min of the range to consider for insertion
	 * @param max
	 *            the max of the range to consider for insertion
